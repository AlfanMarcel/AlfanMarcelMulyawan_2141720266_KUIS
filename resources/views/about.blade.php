...
<body>
    ...
    <div class="container-fluid lead">
        <div class="row">
            <div class="col-12 col-md-12 p-3 p-md-5 text-center"> <img src="{{URL::asset('/uploads/ss.png')}}" class="img-fluid animate__animated animate__bounceInDown" />
                <div class="p-3 p-md-5 ">
                    <h1>About Us</h1>
                    <h3>About Lava CMS Blog Developer</h3>
                    <p> This source code project develope by lava web apps, a team from axora technology, lava web app is modern point of sale application for help you bussiness,with online clouds point of sale and of course support with android iphone windows and other os . and if you need modern website including application and APK android you can visit <a href="https://axcora.com">https://axcora.com</a> , for we open source code project you can download we source code project on <a href="https://www.hockeycomputindo.com/2010/12/blog-post.html">https://www.hockeycomputindo.com/2010/12/blog-post.html</a></p>
                    <p> Lava blog cms build and develope using new version of laravel, and of course we have deploy powerfull on SEO, you can see if you create post article automaticly SEO title, description include meta facebook and twitter card is fetch your title and description, with this metode, so you no need wory about SEO, and optional you can download google html tag then upload on your public folder for SEO optimation, and we hope you can use and helping you for build and develope modern website using laravel php artisan.</p>
                    <p>Download Lava CMS BLog now</p><a href="https://github.com/mesinkasir/lavablog" class="btn btn-dark rounded" target="_blank"><i class="fab fa-github"></i> Github</a>
                    <p class="border p-3"> <br />Donation <br />make a contribution by sharing our application with the world through your social media or voluntary donations to our account so we can give the best for you again. <br />Donate Now using moneygram or western union send money to we local bank account. <br />BANK CENTRAL ASIA <br />ACCOUNT NO : 0181884109 <br />ACCOUNT NAME : SUCI CHANIFAH <br />IBAN/SWIFT CODE : CENAIDJA</p>
                </div>
            </div>
        </div>
