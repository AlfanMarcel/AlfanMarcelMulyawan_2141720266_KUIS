...
<body>
    <div class="container-fluid lead">
        <div class="row">
            <div class="col-12 col-md-12 p-3 p-md-5 text-center"><img src="{{URL::asset('/uploads/the-new-artisan-blog.png')}}" class="img-fluid animate__animated animate__bounceInDown">
            ...
            <div class="col-12 col-md-4 p-3 p-md-5 text-center text-white">
                <div class="bg-danger p-3 p-md-5 shadow rounded animate__animated animate__backInDown repeat: true">
                    <h3 class="text-white">Modern</h3><svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-award" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-12 col-md-4 p-3 p-md-5 text-center text-white">
                <div class="bg-danger p-3 p-md-5 shadow rounded animate__animated animate__backInDown">
                    <h3 class="text-white">Blast</h3><svg xmlns="http://www.w3.org/2000/svg" width="86" height="86" fill="currentColor" class="bi bi-lightning-charge" viewBox="0 0 16 16">
            ...
            <div class="col-12 col-md-4 p-3 p-md-5 text-center text-white">
                <div class="bg-danger p-3 p-md-5 shadow rounded animate__animated animate__backInDown">
                    <h3 class="text-white">Easy</h3><svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-controller" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="uk-child-width-1-2@m uk-grid-match" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-body shadow rounded bg-dark text-white" uk-scrollspy="cls: uk-animation-slide-left; repeat: true">
                            ...
                            <p>Simple blog content management system develope using laravel for build new modern website fast and powerfull.</p>
                            <p>php artisan serve - and your site is live now.</p>
                        </div>
                    </div>
                    <div>
                        <div class="" uk-scrollspy="cls: uk-animation-slide-right; repeat: true"><video width="1200" src="{{ asset('img/laras.mp4') }}" loop muted playsinline uk-video="autoplay: inview"></video></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-12 p-3 p-md-5 text-center text-white">
                <div class="uk-child-width-1@m" uk-grid uk-scrollspy="cls: uk-animation-slide-bottom; target: .uk-card; delay: 300; repeat: true">
                    <div>
                        <div class="bg-danger p-3 p-md-5 shadow rounded" uk-scrollspy="cls:uk-animation-slide-top; repeat: true">
                            <h3 class="text-white">LAVA Web Apps</h3>
                            <p class="border p-3">This is a open source code project present by LAVA Web apps , visit lava web app if you need develope website and application using laravel ,<a href="https://lavapos.vercel.app/" class="text-white border p-1" target="_blank">Visit Lava →</a></p>
                            <p>Lava blog cms is a new generation for build modern website apps using laravel framework, simple and easy to learn , very fast for develope your site. for blog demo you can login using email : admin@admin.com / password : 12345678</p><a href="/blog" class="btn btn-light border border-danger">Visit Blog</a><a href="/login" class=" border border-danger btn btn-light">Login Now</a>
                        </div>
                    </div>
                </div>
            </div>
